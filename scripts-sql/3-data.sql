...
-- Memo
INSERT INTO memo (idmemo, idcategorie, titre, description, flagurgent, statut, effectif, budget, echeance, heure) VALUES
( 1, 1, 'Mémo n°1', 'Texte du mémo n°1', TRUE,'F', 2, 1234.56, {d '2023-02-25' }, {t '18:30' } ),
( 2, 1, 'Mémo n°2', 'Texte du mémo n°2', FALSE,'E', 4, 5000.00, {d '2023-05-18' }, {t '09:15' }),
( 3, NULL,'Mémo n°3', NULL, TRUE, 'A', NULL, NULL, NULL, NULL);
...
(1, 'Hopital', 2011, TRUE, NULL),
(2, 'Ecole', 2009, TRUE, 3),
(3, 'Pompier', 2001, FALSE, 15),
(4, 'Pharmacie', 1997, TRUE, 11);
